...
def retrieveData():
    ...
    credentials = ServiceAccountCredentials.from_json_keyfile_name('encoded-blend-396808-93348f685010.json', scope)

    # Connect to Google Sheets
    client = gspread.authorize(credentials)

    # Open the desired sheet
    sheet = client.open_by_key('93348f6850105430deefcc78c11a2c750a7bfa31').get_worksheet(0)
